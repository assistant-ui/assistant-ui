...
const presets = [
  ...
  },
  {
    ...
    description: "Spawns multiple subagents",
    prompt:
      "I need you to research this codebase thoroughly. Use the Task tool to spawn parallel subagents: one to analyze the directory structure and list key files, another to find and summarize any README or documentation files, and a third to identify the main entry points. Coordinate their findings into a summary.",
    features: ["Subagents", "Parallel"],
  },
];
                  ...
                  className={cn(
                    ...
                    feature === "High Risk"
                      ...
                      : feature === "Extended Thinking" ||
                        ...
                        : feature === "Subagents" || feature === "Parallel"
