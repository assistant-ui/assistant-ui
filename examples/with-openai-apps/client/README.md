...
│  │                                                           │  │
│  │    When AI calls pizza-map tool:                        │  │
│  │                                                           │  │
│  │    ┌─────────────────────────────────────────────────┐   │  │
│  │    │  IFRAME (sandbox="allow-scripts")               │   │  │
│  │    │  src="localhost:3001/render?component=Pizzaz"    │   │  │
│  │    │                                                   │   │  │
│  │    │  ┌─────────────────────────────────────────┐     │   │  │
│  │    │  │  PizzaMap (from MCP server bundle)      │     │  │  │
│  │    │  │                                         │     │  │  │
...
- `../mcp-server-with-ui/src/ui/index.ts` - The UI bundle with PizzaMap component
- `../mcp-server-with-ui/src/ui-server.ts` - Development server for UI hosting
- `../mcp-server-with-ui/manifest.dev.json` - Manifest describing available components
...
| Bundle URL | `localhost:3001/bundle.js` | `app-mcp.auiusercontent.com/bundle.js` |
| Render URL | `localhost:3001/render` | `app-mcp.auiusercontent.com/render` |
...
```bash
cd ../mcp-server-with-ui && pnpm dev:ui
```
...
```
http://localhost:3001/v1/servers/app-mcp/manifest.json
```
