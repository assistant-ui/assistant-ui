  ...
  return (
    <section className="rounded-2xl border border-black/20 bg-[#fffaf5] p-4">
      <header className="mb-3">
        <p className="font-semibold text-black/60 text-xs uppercase tracking-[0.2em]">
          {label}
        </p>
      </header>
      <pre className="max-h-64 overflow-auto rounded-xl bg-white p-3 font-mono text-black/70 text-xs shadow-sm">
        {pretty}
      </pre>
    </section>
  );
...
function App() {
  ...
  const itemCards = cartItems.length ? (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="h-8 w-8 rounded-full border border-black/30 font-semibold text-black/70 text-lg transition hover:bg-white"
    ...
    <div className="rounded-2xl border border-black/40 border-dashed bg-[#fffaf5] p-6 text-center text-black/60 text-sm">
  ...
  return (
    <div
      className="min-h-screen w-full bg-[radial-gradient(circle_at_top_left,_#fff7ed_0,_#ffffff_55%),radial-gradient(circle_at_bottom_right,_#eef2ff_0,_#ffffff_45%)] bg-white text-black"
      style={{
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-8 md:px-6 lg:px-8">
        ...
        >
          <section className="space-y-4">
            <header className="flex items-center justify-between">
              <p className="font-semibold text-black/70 text-sm uppercase tracking-widest">
                Suggested items
              </p>
            </header>
              ...
              {suggestedItems.map(({ name, description, Icon }, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded-full bg-amber-200 px-3 py-1.5 font-semibold text-black text-xs transition hover:bg-amber-300"
                  >
                    Add
                  </button>
                </div>
          ...
          <section className="space-y-4">
            ...
            <button
              ...
              className="w-full rounded-2xl border border-black/30 bg-white py-3 font-semibold text-black/70 text-sm transition hover:border-black/50 disabled:cursor-not-allowed disabled:opacity-70"
            >
              Check out
            </button>
          </section>
        ...
        <section className="space-y-3">
          <header className="flex items-center justify-between">
            ...
            <span className="text-black/60 text-xs">Debug view</span>
          </header>
