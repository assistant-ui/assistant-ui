  ...
  return (
    <>
      <div
        ...
        className={
          "relative min-h-[480px] w-full overflow-hidden antialiased" +
          (displayMode === "fullscreen"
            ? "rounded-none border-0"
            : "rounded-2xl border border-black/10 sm:rounded-3xl dark:border-white/10")
        }
      >
        <Outlet />
        {displayMode !== "fullscreen" && (
          <Button
            ...
            className="pointer-events-auto absolute top-4 right-4 z-30 bg-white text-black shadow-lg"
            color="secondary"
            size="sm"
            variant="soft"
            uniform
        ...
        <div
          className={
            ...
            (displayMode === "fullscreen"
              ? "top-2 right-2 bottom-4 left-[340px] rounded-3xl border border-black/10"
              : "")
          }
        >
          <div
      ...
      {displayMode === "fullscreen" && (
        <div className="pointer-events-none absolute inset-x-0 bottom-2 z-30 hidden justify-center antialiased md:flex">
