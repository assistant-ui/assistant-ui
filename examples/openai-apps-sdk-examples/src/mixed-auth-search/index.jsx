...
function App() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-2xl border border-black/10 bg-white text-black antialiased">
      <div className="px-5 pt-5 pb-4">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="font-semibold text-base">Pizzaz spotlights</div>
        ...
        {toppingLabel && (
          <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-[#F46C21]/10 px-3 py-1 font-medium text-[#F46C21] text-xs">
      ...
      <div className="relative px-5 pb-6">
        ...
        {canPrev && (
          <button
            aria-label="Previous"
            className="absolute top-1/2 left-3 z-10 inline-flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white text-black shadow-lg ring ring-black/5 hover:bg-white"
        ...
        {canNext && (
          <button
            aria-label="Next"
            className="absolute top-1/2 right-3 z-10 inline-flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white text-black shadow-lg ring ring-black/5 hover:bg-white"
