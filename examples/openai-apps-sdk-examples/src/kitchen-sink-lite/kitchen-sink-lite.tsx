...
function Card({
  ...
  return (
    <section className="flex flex-col gap-3 rounded-xl border border-default bg-surface p-4 shadow-sm">
      <header className="flex flex-wrap items-start gap-3">
        <div className="flex items-center gap-2 text-secondary text-xs">
          <span className="inline-block h-2.5 w-2.5 rounded-full bg-primary/80" />
          {apiLabel ? (
        ...
        <div className="flex min-w-0 flex-col gap-1">
          <h2 className="truncate font-semibold text-primary text-sm leading-tight">
            {title}
          </h2>
          {description ? (
...
export default function KitchenSinkLite() {
  ...
  const userAgent = useOpenAiGlobal("userAgent") as Record<
    string,
    unknown
  > | null;
  ...
  const handleRefreshWidgetStateView = () => {
    const hostState =
      (window.openai?.widgetState as DemoWidgetState | null) ?? null;
    if (hostState) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-default bg-surface p-4 text-primary shadow-sm">
      <header className="flex flex-col gap-1 border-primary/70 border-l-4 pl-3">
        <p className="font-semibold text-[11px] text-secondary uppercase tracking-[0.16em]">
          Kitchen sink lite
        </p>
        <h1 className="font-semibold text-xl">
          Minimal widget + MCP server example
        </h1>
        <p className="text-secondary text-sm leading-snug">
          Tool output populates the widget; window.openai powers callbacks like
          widget state, callTool, openExternal, and display mode.
        </p>
      </header>
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-default bg-surface p-3">
        <div className="flex flex-col gap-1">
          <p className="font-semibold text-[11px] text-secondary uppercase tracking-[0.12em]">
            Capability
          </p>
          <h2 className="font-semibold text-base text-primary">Tool I/O</h2>
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-secondary text-xs">Source: model → MCP tool</p>
          </Card>
          ...
          >
            <div className="flex flex-col gap-2">
              <p className="text-secondary text-xs uppercase tracking-[0.08em]">
                message
              </p>
              <p
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-default bg-surface p-3">
        <div className="flex flex-col gap-1">
          ...
          <h2 className="font-semibold text-base text-primary">Widget state</h2>
          <p className="text-secondary text-sm">
        ...
        >
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1 text-sm">
              <span className="text-[11px] text-secondary uppercase tracking-[0.08em]">
                Current widgetState
              </span>
              <CodeBlock
                className="ks-code-block ks-code-block--compact"
        ...
        >
          <div className="flex flex-col gap-3">
            <label className="flex flex-col gap-1 text-sm">
              ...
              <Input
                value={anyToolName}
                onChange={(e) => setAnyToolName(e.target.value)}
              />
            </label>
            <label className="flex flex-col gap-1 text-sm">
            ...
            {anyToolError ? (
              <p className="text-red-600 text-sm">{anyToolError}</p>
            ) : null}
          </div>
        </Card>
      </div>
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-default bg-surface p-3">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-secondary text-sm">
            Environment and helpers exposed by ChatGPT.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <Card
          ...
          >
            ...
            <p className="text-secondary text-xs">
              Example: platform.openai.com/docs/guides/apps
            </p>
            <div className="flex flex-wrap gap-2">
              <Button
                variant="outline"
      ...
      <div className="flex flex-col gap-3 rounded-2xl border border-default bg-surface p-3">
        <div className="flex flex-col gap-1">
          ...
          <h2 className="font-semibold text-base text-primary">Event log</h2>
          <p className="text-secondary text-sm">
            Recent calls from this widget to window.openai.
          </p>
        </div>
        <div className="max-h-48 overflow-auto rounded-lg border border-default bg-subtle p-3">
          {events.length === 0 ? (
