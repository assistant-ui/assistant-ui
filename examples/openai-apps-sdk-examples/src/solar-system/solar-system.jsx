...
function SolarSystem() {
  ...
  return (
    <div
      className={`relative w-full overflow-hidden bg-black antialiased ${
    ...
    >
      {displayMode !== "fullscreen" && (
        <div className="fixed end-3 top-3 z-20 aspect-square rounded-full bg-white/20 p-2 text-white backdrop-blur-lg">
          <button
            onClick={() => {
      ...
      <AnimatePresence>
        {currentPlanet && (
          <motion.div
            ...
            className="pointer-events-none absolute inset-0 z-10 flex flex-col items-center justify-end rounded-xl bg-gradient-to-t from-black/80 to-black/0 px-8 pb-4 text-center text-white sm:p-8 md:w-72 md:items-start md:justify-start md:bg-gradient-to-r md:from-black md:to-black/0 md:text-left"
          >
