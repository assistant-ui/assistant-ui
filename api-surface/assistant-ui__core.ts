import React, { ComponentType, FC, PropsWithChildren, ReactNode, RefObject } from "react";
...
declare abstract class BaseThreadRuntimeCore implements ThreadRuntimeCore {
  ...
  subscribe(callback: () => void): Unsubscribe$1;
  submitFeedback(_param: SubmitFeedbackOptions): void;
...
declare class LocalThreadRuntimeCore extends BaseThreadRuntimeCore implements ThreadRuntimeCore {
  ...
  resumeRun(_param: ResumeRunConfig): Promise<void>;
  exportExternalState(): any;
  importExternalState(): void;
  startRun(_param: StartRunConfig, runCallback?: ChatModelAdapter["run"]): Promise<void>;
  private _runLoop;
  private performRoundtrip;
  detach(): void;
  cancelRun(): void;
  addToolResult(_param: AddToolResultOptions): void;
  resumeToolCall(_options: ResumeToolCallOptions): void;
  respondToToolApproval(_param: RespondToToolApprovalOptions): void;
}
...
declare const defaultComponents: {
  ...
  File: () => null;
  Unstable_Audio: () => null;
  ToolGroup: (_param: PropsWithChildren) => ReactNode;
  ReasoningGroup: (_param: PropsWithChildren) => ReactNode;
};
...
declare const useActionBarCopy: (_param?: UseActionBarCopyOptions) => {
  copy: () => void;
  disabled: boolean;
  isCopied: boolean;
};
...
declare const useSuggestionTrigger: (_param: UseSuggestionTriggerOptions) => {
  trigger: () => void;
  disabled: boolean;
};
...
declare namespace internal_d_exports$1 {
...
export { index_d_exports as entry_0_root, internal_d_exports as entry_1_internal, index_d_exports$1 as entry_2_react, index_d_exports$2 as entry_3_store, internal_d_exports$1 as entry_4_store_internal };
