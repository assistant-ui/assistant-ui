...
type ExternalMessageConversionCache$1 = {
...
declare const convertExternalMessages: <T extends WeakKey>(messages: T[], callback: useExternalMessageConverter.Callback<T>, isRunning: boolean, metadata: useExternalMessageConverter.Metadata, cache?: ExternalMessageConversionCache$1) => ThreadMessage[];
...
declare const createExternalMessageConversionCache: () => ExternalMessageConversionCache$1;
