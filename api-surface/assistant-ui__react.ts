...
declare const useLocalRuntime: (chatModel: ChatModelAdapter, _param11?: LocalRuntimeOptions) => AssistantRuntime;
...
type ThreadViewportState = {
  ...
  readonly onScrollToBottom: (callback: (_param12: {
...
declare const useAssistantFrameHost: (_param14: UseAssistantFrameHostOptions) => void;
...
declare const useActionBarPrimitiveCopy: (_param15?: {
...
declare const useActionBarExportMarkdown: (_param16?: {
...
declare const useComposerAddAttachment: (_param17?: {
...
declare const useSuggestionTrigger: (_param20: {
  send?: boolean | undefined;
  clearComposer?: boolean | undefined;
}) => (() => void) | null;
