...
type ThreadViewportState = {
  ...
  readonly registerViewportElement: (element: HTMLElement | null) => Unsubscribe$2;
  readonly registerAnchorElement: (element: HTMLElement | null) => Unsubscribe$2;
...
type UseAssistantFrameHostOptions = {
  ...
  targetOrigin?: string;
  register: (frameHost: AssistantFrameHost) => Unsubscribe$2;
};
