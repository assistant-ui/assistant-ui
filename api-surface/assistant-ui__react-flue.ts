...
type FlueRuntimeExtras = Pick<UseFlueAgentResult, "error" | "failedSends" | "historyReady" | "messages" | "refresh" | "settlements" | "status">;

type FlueSendMessage = {
  readonly message: string;
...
type UseFlueRuntimeOptions = UseFlueAgentOptions & ExternalStoreSharedOptions & {
  readonly adapters?: {
  ...
  readonly getSendOptions?: ((message: AppendMessage) => FlueSendOptions | undefined) | undefined;
};
...
declare const getFlueSendMessage: (message: AppendMessage) => FlueSendMessage;
...
declare const useFlueRuntimeExtras: () => FlueRuntimeExtras;
