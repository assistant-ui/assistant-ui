...
declare class IncrementalPartialJsonObjectParser {
  #private;
  private constructor();
  static from(text: string, fallback?: ReadonlyJSONObject): IncrementalPartialJsonObjectParser;
  get currentText(): string;
  get currentArgs(): ReadonlyJSONObject;
  append(delta: string, fullText?: string): IncrementalPartialJsonObjectParser;
}
...
declare namespace entry_utils_exports {
  export { AssistantMetaTransformStream, AssistantTransformStream, AsyncIterableStream, IncrementalPartialJsonObjectParser, ReadonlyJSONArray, ReadonlyJSONObject, ReadonlyJSONValue, SSEEvent, SSEEventDecoder, asAsyncIterableStream, getPartialJsonObjectFieldState, getPartialJsonObjectMeta, parsePartialJsonObject };
}
