...
const defaultComponents = memoizeMarkdownComponents({
  ...
  table: ({ className, ...props }) => (
    <table
      className={cn(
        "aui-md-table my-3 w-full border-separate border-spacing-0 [scrollbar-width:thin] [scrollbar-color:var(--color-border)_transparent] overflow-y-auto",
        className,
      )}
      {...props}
    />
  ...
  pre: ({ className, ...props }) => (
    <pre
      className={cn(
        "aui-md-pre border-border/50 bg-muted/30 [scrollbar-width:thin] [scrollbar-color:var(--color-border)_transparent] overflow-x-auto rounded-t-none rounded-b-xl border border-t-0 p-3.5 text-[13px] leading-relaxed",
        className,
      )}
      {...props}
    />
