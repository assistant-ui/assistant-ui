  ...
  parameters={[
    {
      name: "tool",
      type: "Tool",
      description: "A tool definition created using the tool() helper function",
      children: [
        {
          parameters: [
            {
              name: "parameters",
              type: "ZodSchema",
              description: "Zod schema defining the tool's parameters",
            },
            {
              name: "execute",
              type: "function",
              description: "Function that implements the tool's behavior",
            },
          ],
        },
      ],
