...
- **Attachment Adapters**: Backend logic for processing files
...
This adds `/components/assistant-ui/attachment.tsx` with customizable components.
...
- [Example Apps](/docs/examples) - Full implementations with attachments
