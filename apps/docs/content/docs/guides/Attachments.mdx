...
// Output: Complete attachment content (audio parts for mp3/wav, file part for other formats) containing the data URL
```
...
// Output: Complete attachment whose content contains a video file part with the data URL
```
