...
>
  <FlowCanvas
    edges={[
      { from: "datastream", to: "local", route: "down", midFrac: 0.4 },
  ...
  >
    <div className="grid max-w-2xl grid-cols-[1fr_1.6fr] gap-4">
      <FlowGroup label="Protocol layers">
        <FlowRow className="flex-wrap justify-start">
          <FlowNode id="datastream">DataStream</FlowNode>
          <FlowNode id="transport">AssistantTransport</FlowNode>
        </FlowRow>
      </FlowGroup>
      <FlowGroup id="adapters" label="Framework adapters">
        <FlowRow className="flex-wrap justify-start">
          <FlowNode>react-ai-sdk</FlowNode>
          <FlowNode>react-langgraph</FlowNode>
          <FlowNode>react-langchain</FlowNode>
          <FlowNode>react-google-adk</FlowNode>
          <FlowNode>react-a2a</FlowNode>
          <FlowNode>react-ag-ui</FlowNode>
          <FlowNode>react-opencode</FlowNode>
        </FlowRow>
      </FlowGroup>
    </div>
    <div className="h-14" aria-hidden />
    <FlowGroup label="Core runtimes" className="mx-auto w-fit">
      <FlowRow className="gap-10">
        <FlowNode id="local">LocalRuntime</FlowNode>
        <FlowNode id="external">ExternalStoreRuntime</FlowNode>
      </FlowRow>
    </FlowGroup>
  </FlowCanvas>
</Flow>
