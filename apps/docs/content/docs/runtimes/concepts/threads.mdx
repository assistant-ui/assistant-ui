...
<ParametersTable
  ...
  parameters={[
    ...
    {
      name: "unstable_scopeKey",
      type: "unknown",
      description:
        "Optional account or workspace identity. Change it when the adapter starts serving a different scope so cached threads and mounted runtimes are cleared.",
    },
    {
