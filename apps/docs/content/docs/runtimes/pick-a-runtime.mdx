...
graph TD
    ...
    B -->|Tambo AI| J[Use Tambo Integration Guide]
...
<Cards>
  ...
  <Card
    title="Tambo AI"
    description="Use Tambo thread state and streaming with assistant-ui components"
    href="/docs/runtimes/tambo"
  />
  <Card
    title="Mastra"
...
- **Tambo Integration** → Built on `ExternalStoreRuntime` with Tambo hooks/state
...
2. **Follow the specific guide**:
   ...
   - [Tambo Integration](/docs/runtimes/tambo)
