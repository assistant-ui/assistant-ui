...
- **[LangGraph Interrupt Example](https://github.com/assistant-ui/assistant-ui-langgraph-interrupt)** - LangGraph with interrupt support (separate repo)
- **[React Hook Form Example](https://github.com/assistant-ui/assistant-ui/tree/main/examples/with-react-hook-form)** - Form integration with assistant tools
- **[FFmpeg Example](https://github.com/assistant-ui/assistant-ui/tree/main/examples/with-ffmpeg)** - Video processing with assistant tools
- **[Local Ollama Example](https://github.com/assistant-ui/assistant-ui/tree/main/examples/local-ollama)** - Local AI model integration
- **[E-commerce Search Agent](https://github.com/assistant-ui/assistant-ui/tree/main/examples/search-agent-for-e-commerce)** - Advanced search agent implementation
