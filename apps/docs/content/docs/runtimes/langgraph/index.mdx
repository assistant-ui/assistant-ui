...
```tsx title="@/api/api/[...path]/route.ts"
...
```tsx include chatApi title="@/lib/chatApi.ts"
...
```tsx include MyAssistant title="@/components/MyAssistant.tsx"
