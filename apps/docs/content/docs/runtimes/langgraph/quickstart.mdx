...
```sh
npx expo install @assistant-ui/react-native @assistant-ui/react-langgraph @langchain/langgraph-sdk
```
...
```sh
npm install @assistant-ui/react-ink @assistant-ui/react-langgraph @langchain/langgraph-sdk ink react
```
