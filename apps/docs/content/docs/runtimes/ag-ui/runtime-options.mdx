...
Starting a thread switch cancels the active agent run and discards messages queued
for the previous thread before calling your adapter. Cancelling an active run
