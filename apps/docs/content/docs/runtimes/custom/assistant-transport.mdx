...
>
  <FlowRow>
    ...
    <FlowArrow label="Commands" reverseLabel="State snapshots" length={150} />
    <FlowNode>Agent server</FlowNode>
  </FlowRow>
</Flow>
...
>
  <FlowRow>
    <FlowNode>queued</FlowNode>
    <FlowArrow label="sent to backend" length={120} />
    <FlowNode>in_transit</FlowNode>
    <FlowArrow label="backend processes" length={132} />
    <FlowNode>applied</FlowNode>
  </FlowRow>
</Flow>
...
>
  ...
  >
    <FlowRow>
      <FlowNode id="idle">idle</FlowNode>
      <FlowArrow label="new command" length={108} />
      <FlowNode id="sending">sending</FlowNode>
      <FlowArrow label="request completes" length={132} />
      <FlowNode id="check" variant="decision">check queue</FlowNode>
    </FlowRow>
