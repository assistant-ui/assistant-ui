...
>
  ...
  >
    <FlowColumn>
      <FlowNode id="state">Your state</FlowNode>
      <FlowArrow direction="down" label="messages" length={36} />
      <FlowNode id="adapter">ExternalStoreAdapter</FlowNode>
      <FlowArrow direction="down" length={36} />
      <FlowNode>ExternalStoreRuntime</FlowNode>
      <FlowArrow direction="down" length={36} />
      <FlowNode id="components">assistant-ui components</FlowNode>
    </FlowColumn>
  </FlowCanvas>
</Flow>
