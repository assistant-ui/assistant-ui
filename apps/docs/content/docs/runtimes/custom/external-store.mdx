...
| `onVoiceTranscript` | Persisting finalized voice transcripts as host messages |
...
<ParametersTable
  ...
  parameters={[
    ...
    },
    {
      ...
      description:
        "Receives each finalized voice transcript message; append it to your messages under the same id so it persists. Without it, transcripts stay for the session only.",
    },
    {
