...
```sh
npx expo install @assistant-ui/react-native @assistant-ui/react-ai-sdk ai@^6 @ai-sdk/react@^3 @ai-sdk/openai zod
```
...
```sh
npm install @assistant-ui/react-ink @assistant-ui/react-ai-sdk ai@^6 @ai-sdk/react@^3 @ai-sdk/openai zod ink react
```
