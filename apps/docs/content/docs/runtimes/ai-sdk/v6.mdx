...
```
> Note: assistant-ui automatically aggregates token usage from finish-step. Alternatively, you can pass total usage during the finish event via usage: part.totalUsage.
  </Step>
  <Step>
