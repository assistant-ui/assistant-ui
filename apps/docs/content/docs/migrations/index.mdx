...
<Cards>
  <Card title="Migration to v0.16" href="/docs/migrations/v0-16">
    Name runtime state with the `*RuntimeState` types; `ThreadState` and its
    siblings now name the store states.
  </Card>
  <Card title="Migration to v0.15" href="/docs/migrations/v0-15">
    Replace the removed legacy runtime hooks, and read scope accessors as
    properties.
  </Card>
