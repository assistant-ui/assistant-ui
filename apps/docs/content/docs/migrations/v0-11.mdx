...
If you see "Part is only available inside <MessagePrimitive.Parts />", you're likely using the old component name or incorrect structure. See the [Markdown documentation](/docs/ui/Markdown#troubleshooting) for detailed troubleshooting steps.
