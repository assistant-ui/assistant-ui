...
>
  <FlowColumn>
    <FlowNode tone="pink">Frontend Components</FlowNode>
    <FlowArrow direction="down" length={36} />
    <FlowNode tone="blue">Runtime</FlowNode>
    <FlowArrow direction="down" length={36} />
    <FlowNode tone="red">External Providers or LLM APIs</FlowNode>
  </FlowColumn>
</Flow>
...
>
  <FlowColumn>
    ...
    <FlowNode tone="blue">Runtime</FlowNode>
    <FlowArrow direction="down" length={36} />
    <FlowNode tone="red">Your API Backend</FlowNode>
    <FlowArrow direction="down" length={36} />
    <FlowNode tone="red">External Providers or LLM APIs</FlowNode>
  </FlowColumn>
</Flow>
...
>
  ...
  >
    <FlowColumn>
      <FlowNode tone="pink">Frontend Components</FlowNode>
      <FlowArrow direction="down" length={36} />
      <FlowNode id="runtime" tone="blue">Runtime</FlowNode>
      <div className="h-10" aria-hidden />
      <FlowRow>
        <FlowNode id="backend" tone="red">Your API Backend</FlowNode>
        <FlowArrow length={48} />
        <FlowNode id="cloud" tone="green">Cloud</FlowNode>
      </FlowRow>
      <div className="h-10" aria-hidden />
      <FlowNode id="providers" tone="red">External Providers or LLM APIs</FlowNode>
    </FlowColumn>
  </FlowCanvas>
</Flow>
