...
**What it does:**
- Applies compatible codemods sequentially
...
Projects using legacy packaged UI components stop before any files are changed.
Follow the [v0.15 migration guide](/docs/migrations/v0-15) to move those
components to the registry, then run the upgrade command again.
