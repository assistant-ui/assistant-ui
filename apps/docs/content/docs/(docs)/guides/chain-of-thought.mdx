...
<Callout type="tip">
  **Seen in production:** [OpenOps](https://github.com/openops-cloud/openops) (1k stars) uses Chain of Thought with a `Reasoning` component to show the AI's decision process behind cloud cost optimization recommendations, letting users expand intermediate reasoning steps and tool calls.
</Callout>
