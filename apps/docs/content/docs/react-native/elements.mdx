...
function ComposerInput() {
  const isEditing = useAuiState((s) => s.composer.type === "edit");
  return isEditing ? <ComposerPrimitive.Input multiline /> : <RichEditor />;
}
