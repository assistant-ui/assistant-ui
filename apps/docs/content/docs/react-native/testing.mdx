...
An Expo app ships none of the packages this setup needs. Install the two the SDK pins through Expo and the test runner as dev dependencies, then add a `test` script so the commands below have something to run.
