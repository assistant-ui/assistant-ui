...
The [`with-mastra` example](https://github.com/assistant-ui/assistant-ui/tree/main/examples/with-mastra) demonstrates two consecutive suspensions, run restoration after reload, resume, cancel, and final result rendering.
