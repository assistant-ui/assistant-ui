...
description: Adapter interfaces for connecting chat models, persistence, file attachments, feedback, suggestions, and speech to assistant-ui React runtimes.
---
...
<Cards>
  ...
  <Card title={"Feedback Adapter"} href={"/docs/api-reference/adapters/feedback-speech"}>
    {"Feedback collection and speech synthesis adapters for assistant-ui messages, ratings, spoken output, and playback controls."}
  </Card>
