...
<ParametersTable
  ...
  parameters={[
    ...
    {
      name: "fillClampThreshold",
      type: "string",
      default: '"10em"',
      description:
        'Anchored user messages up to this height remain fully visible when turnAnchor is "top". Taller messages are clamped to fillClampOffset.',
    },
    {
      name: "fillClampOffset",
      type: "string",
      default: '"6em"',
      description:
        'Visible height retained for anchored user messages taller than fillClampThreshold when turnAnchor is "top".',
    },
    {
