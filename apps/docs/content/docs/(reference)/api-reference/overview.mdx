---
title: API Reference
description: Complete API reference for assistant-ui React APIs, including primitives, hooks, runtimes, adapters, tools, model context, transport, voice, and integrations.
---
...
<Cards>
  <Card title="Tools" href="/docs/api-reference/tools/definition">
...
- [`makeAssistantTool`](/docs/api-reference/tools/definition)
- [`makeAssistantToolUI`](/docs/api-reference/tools/rendering)
- [`useAssistantTool`](/docs/api-reference/tools/definition)
