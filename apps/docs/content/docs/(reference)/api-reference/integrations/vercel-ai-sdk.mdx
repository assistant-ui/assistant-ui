...
description: Vercel AI SDK v6 integration with chat runtime hooks and transport utilities.
---
...
<Callout type="info">
  This package provides integration with AI SDK v6. For AI SDK v5, see the [AI
  SDK v5 (Legacy)](/docs/runtimes/ai-sdk/v5-legacy) documentation.
</Callout>
...
Creates a runtime directly with AI SDK v6's `useChat` hook integration. This is the recommended approach for most use cases.
