...
<Cards>
  ...
  <Card title={"@assistant-ui/react-mastra"} href={"/docs/api-reference/integrations/react-mastra"}>
    {"Mastra memory thread adapters, chat transport, and durable workflow hooks for assistant-ui React applications."}
  </Card>
