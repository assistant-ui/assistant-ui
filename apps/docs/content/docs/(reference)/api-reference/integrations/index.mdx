...
<Cards>
  ...
  <Card title={"@assistant-ui/react-flue"} href={"/docs/api-reference/integrations/react-flue"}>
    {"Flue runtime hook, message converters, and durable conversation state for assistant-ui React applications."}
  </Card>
