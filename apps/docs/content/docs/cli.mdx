...
This will:
- Detect if you have an existing Next.js project
- Run `shadcn init` if needed to set up the component infrastructure
- Add the default assistant-ui components (thread, composer, etc.)
...
- **Documentation**: [assistant-ui.com/docs](https://assistant-ui.com/docs)
- **GitHub Issues**: [github.com/assistant-ui/assistant-ui/issues](https://github.com/assistant-ui/assistant-ui/issues)
- **Discord**: [Join our community](https://discord.gg/S9dwgCNEFs)
