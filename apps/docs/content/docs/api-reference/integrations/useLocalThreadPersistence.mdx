...
- [with-ai-sdk-v5](/examples/with-ai-sdk-v5) — AI SDK runtime (no persistence)
- [with-external-store](/examples/with-external-store) — full persistence control
- [with-thread-history-adapter](/examples/with-thread-history-adapter) — message-only persistence