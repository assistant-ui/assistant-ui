...
|------|------|---------|-------------|
| `url` | `string` | — | URL for a URL source; not present for a document source |
| `title` | `string \| undefined` | — | Display title; URL sources use the domain if the title is not present |
