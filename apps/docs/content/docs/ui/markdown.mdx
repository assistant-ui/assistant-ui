...
import { MarkdownCodeBlockSample } from "@/components/docs/samples/markdown/code-block-and-copy";
...
Fenced code blocks get a language header and a copy button, and inline code keeps compact styling.

<PreviewCode file="components/docs/samples/markdown/code-block-and-copy" name="MarkdownWithCode">
