...
This adds a `/components/assistant-ui/elements/markdown-text.tsx` file to your project, which you can adjust as needed.
...
```tsx title="/components/assistant-ui/elements/thread.tsx" {1,7}
