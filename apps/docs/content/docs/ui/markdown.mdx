...
import { MarkdownRichDocumentSample } from "@/components/docs/samples/markdown/rich-document";
...
<PreviewCode file="components/docs/samples/markdown/rich-document" name="MarkdownDocument">
