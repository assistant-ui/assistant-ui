...
import { MarkdownGfmSample } from "@/components/docs/samples/markdown/gfm-extras";
...
<PreviewCode file="components/docs/samples/markdown/gfm-extras" name="GfmMarkdown">
  <MarkdownGfmSample />
</PreviewCode>
