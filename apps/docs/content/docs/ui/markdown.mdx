...
import { MarkdownStreamingSample } from "@/components/docs/samples/markdown/streaming-markdown";
...
<PreviewCode file="components/docs/samples/markdown/streaming-markdown" name="StreamingMarkdown">
