...
This adds `/components/assistant-ui/elements/voice.tsx` to your project, which you can adjust as needed.
...
import { VoiceControl } from "@/components/assistant-ui/elements/voice";
