...
Use `orientation="vertical"` for a vertical tab layout.

<PreviewCode file="components/docs/samples/tabs" name="TabsVerticalSample">
  <TabsVerticalSample />
</PreviewCode>
...
CVA function exports for using tab styles outside the components.

```tsx
import { tabsListVariants, tabsTriggerVariants } from "@/components/assistant-ui/tabs";
