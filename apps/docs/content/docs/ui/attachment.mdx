...
This adds a `/components/assistant-ui/elements/attachment.tsx` file to your project, which you can adjust as needed.
...
```tsx title="/components/assistant-ui/elements/thread.tsx" {1-4,9-10}
import {
  ComposerAttachments,
...
```tsx title="/components/assistant-ui/elements/thread.tsx" {1,8}
