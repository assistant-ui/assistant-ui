...
<PreviewCode file="components/docs/samples/attachment/message-attachments" name="AttachmentMessageContextSample" base={<AttachmentMessageContextSample />}>
  <AttachmentMessageRadixSample.AttachmentMessageContextSample />
</PreviewCode>

### Custom Types

This example shows the image tile, the document tile, and the generic fallback tile for a custom attachment type.
