...
import { ThreadConversationSample } from "@/components/docs/samples/thread/scripted-conversation";
...
A deterministic local history shows how the composer docks below a completed multi-turn exchange.

<PreviewCode
  file="components/docs/samples/thread/scripted-conversation"
  name="Chat"
>
  <ThreadConversationSample />
</PreviewCode>
