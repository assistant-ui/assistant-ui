...
While the last assistant response runs, the composer shows the cancel action, not the send action, and the action bar of the response stays hidden.

<PreviewCode
  file="components/docs/samples/thread/running-response"
  name="Chat"
>
  <ThreadRunningSample />
</PreviewCode>
