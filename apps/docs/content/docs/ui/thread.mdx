...
Hover or focus the first assistant response to show its action bar. The last response always shows its actions.

<PreviewCode
  file="components/docs/samples/thread/message-actions"
  name="Chat"
>
  <ThreadActionsSample />
</PreviewCode>
