...
import { ToolFallbackRendererSample } from "@/components/pages/docs/samples/tool-fallback/custom-renderer";
...
<PreviewCode
  file="components/pages/docs/samples/tool-fallback/custom-renderer"
  name="WeatherToolUI"
>
