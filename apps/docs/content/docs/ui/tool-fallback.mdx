...
Select Allow or Deny. Allow records the result "Approved by user". Deny records the result "User denied tool execution". Each choice removes the buttons and shows the recorded result.
