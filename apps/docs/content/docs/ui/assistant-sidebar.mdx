...
This adds `/components/assistant-ui/elements/assistant-sidebar.tsx` to your project, which you can adjust as needed.
...
Since this component is copied to your project at `/components/assistant-ui/elements/assistant-sidebar.tsx`, you can customize:

- Panel default sizes and min/max constraints
- Resize handle styling
- Thread component configuration

```tsx title="/components/assistant-ui/elements/assistant-sidebar.tsx"
