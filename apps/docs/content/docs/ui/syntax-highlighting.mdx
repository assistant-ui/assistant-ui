...
This adds a `/components/assistant-ui/elements/shiki-highlighter.tsx` file to your project and
...
```tsx title="/components/assistant-ui/elements/shiki-highlighter.tsx"
<ShikiHighlighter
  /* ... */
  theme={{
    light: "github-light",
...
```tsx title="/components/assistant-ui/elements/shiki-highlighter.tsx" {3-9}
...
<InstallCommand shadcn={["syntax-highlighter"]} />
    ...
    Adds a `/components/assistant-ui/elements/syntax-highlighter.tsx` file to your project and installs the `react-syntax-highlighter` dependency.
