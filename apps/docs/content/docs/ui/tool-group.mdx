...
This adds `/components/assistant-ui/elements/tool-group.kit.tsx` and `/components/assistant-ui/elements/tool-fallback.tsx` files to your project, which you can adjust as needed.
