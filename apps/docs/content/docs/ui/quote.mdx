...
This adds a `/components/assistant-ui/elements/quote.tsx` file with three components: `QuoteBlock`, `SelectionToolbar`, and `ComposerQuotePreview`.
...
```tsx title="components/assistant-ui/elements/thread.tsx" {1,8-10}
import { QuoteBlock } from "@/components/assistant-ui/elements/quote";
...
```tsx title="components/assistant-ui/elements/thread.tsx" {1,11}
import { SelectionToolbar } from "@/components/assistant-ui/elements/quote";
...
```tsx title="components/assistant-ui/elements/thread.tsx" {1,6}
