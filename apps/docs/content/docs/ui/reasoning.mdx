...
import { ReasoningLongSample } from "@/components/docs/samples/reasoning/long-reasoning";
...
The open disclosure keeps long reasoning inside its scroll area. Scroll the text, then collapse and expand the disclosure.
