...
This adds a `/components/assistant-ui/elements/reasoning.tsx` file to your project.
...
```tsx title="/app/components/assistant-ui/elements/thread.tsx"
...
import {
  ...
  ReasoningText,
  ReasoningTrigger,
} from "@/components/assistant-ui/elements/reasoning"; // [!code ++]
...
```tsx
import { ReasoningGroup } from "@/components/assistant-ui/elements/reasoning";
