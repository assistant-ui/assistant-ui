...
import { ReasoningSample, ReasoningStreamingSample } from "@/components/docs/samples/reasoning";
...
<PreviewCode
  file="components/docs/samples/reasoning"
  name="ReasoningStreamingThread"
>
