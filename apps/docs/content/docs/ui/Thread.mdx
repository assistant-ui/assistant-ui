...
### Conditional UI Based on Thread State
...
// Hide composer when thread is disabled
<ThreadPrimitive.If disabled={false}>
  <Composer />
</ThreadPrimitive.If>
```
...
<ParametersTable
  ...
  parameters={[
    ...
    },
    {
      ...
      default: "'replace'",
      description:
        "How the suggestion interacts with the composer's existing value.",
    },
    {
      name: "autoSend",
      type: "boolean",
      default: "false",
      description:
        "Whether to automatically send the message after applying the suggestion.",
    },
    {
      name: "asChild",
      type: "boolean",
