...
`ModelSelector.Item` accepts custom `children` in place of the default name and description row. This demo uses that to render capability badges with the shadcn `badge` component:
