...
```tsx
<ModelSelector variant="default" /> // No background (default)
<ModelSelector variant="outline" /> // Border only
<ModelSelector variant="muted" />   // Muted background
```

| Variant   | Description                           |
| --------- | ------------------------------------- |
| `default` | No background, subtle hover (default) |
...
```tsx
<ModelSelector size="sm" /> // Compact
<ModelSelector size="md" /> // Standard (default)
<ModelSelector size="lg" /> // Large
```
