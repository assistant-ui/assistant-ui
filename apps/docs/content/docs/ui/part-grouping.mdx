...
<Callout type="tip">
  **Seen in production:** [Adorable](https://github.com/freestyle-sh/Adorable) (682 stars) uses `Unstable_PartsGrouped` to group consecutive file operations (reads, writes, edits) into collapsible summaries like "Updated 3 files, read 2 files, ran 1 command" — creating a clean Cursor/Lovable-style tool execution UI.
</Callout>

See the [Production Patterns](/docs/guides/patterns#tool-call-grouping) guide for a full tool call grouping implementation.
