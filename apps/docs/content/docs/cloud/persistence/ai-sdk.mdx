---
title: AI SDK
description: Integrate cloud persistence using assistant-ui runtime and components.
---
...
assistant-cloud provides thread management and persistent chat history for applications built with the [AI SDK by Vercel](https://sdk.vercel.ai/). This guide shows you how to integrate cloud persistence using assistant-ui's runtime and pre-built components.

<Callout type="tip">
  Using the AI SDK with your own UI components? See [AI SDK (Custom UI)](/docs/cloud/persistence/ai-sdk-hooks) for a lighter integration that works without assistant-ui.
</Callout>
