...
```sh
npx expo install @assistant-ui/react-native @assistant-ui/react-langgraph assistant-cloud
```
...
```sh
npm install @assistant-ui/react-ink @assistant-ui/react-langgraph assistant-cloud ink react
```
