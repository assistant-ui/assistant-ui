...
The **Plan** tile shows the plan name, the billing period's start and end dates, and the days left in that period. The period used for active user limits is the UTC calendar month.
