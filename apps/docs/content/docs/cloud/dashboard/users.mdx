...
Every column sorts. The page opens sorted by Runs and asks for 50 people at a time. The list supports up to 500 people per page. Search matches user ids and display names.
