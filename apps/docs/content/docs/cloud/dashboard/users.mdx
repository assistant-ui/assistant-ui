...
Every column sorts. The page opens sorted by Runs, loads 500 people at a time from a request that accepts 50 to 2,000, and pages them in the table. Search matches user ids and display names.
