...
| **Thumbs down rate** | Opens the matching Threads. |
...
**Tasks** groups repeated requests. Its consistency reading is **Consistent**, **Mixed**, or **Inconsistent**. Open a task to inspect it in the current range. The **Tasks** table carries a **Thumbs down rate** that opens the matching Threads.
...
| Loops | `signal=loop` |
| Thumbs down rate in Topics or Tasks | The matching Threads |
