...
| Tile | What it counts |
|---|---|
| **Analysed** | Conversations the analysis has classified in the selected range. |
| **Junk** | Analysed conversations marked as junk. |
...
Rate readings use the outcome tone when they are above the page mean. A blank Trend cell has no trend reading.
