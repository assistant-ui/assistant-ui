...
|---|---|---|
| Threads | [Threads](/docs/cloud/dashboard/threads) | `from`, `to`, `search`, `created_by`, `satisfaction`, `signal`, `topic`, `task`, `question`, `junk`, `sentiment`, `resolved`, `language`, and `archived`, plus the **Feedback** and **Review** filters. |
