...
<Callout type="warning">
  **Limitations:** The standalone hook does not capture `duration_ms` or per-step timestamps because it doesn't integrate with the assistant-ui runtime. For full timing telemetry, use the [React AI SDK integration](/docs/cloud/ai-sdk-assistant-ui).
</Callout>
