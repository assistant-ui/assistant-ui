...
```sh
npx expo install @assistant-ui/react-native @assistant-ui/react-ai-sdk assistant-cloud
```
...
```sh
npm install @assistant-ui/react-ink @assistant-ui/react-ai-sdk assistant-cloud ink react
```
