    ...
    "events": [
      {
        ...
        "message_id": "message_0qzof3jPoDwr7K3agyJN3D4U",
...
| `429` | `{ "error": "rate_limited" }` with `Retry-After: 60` | The caller exceeded 600 events in 60 seconds. The limit is keyed by user. |
