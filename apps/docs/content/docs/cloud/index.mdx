...
| AG-UI or A2A | thread list, titles, persistence, feedback, attachments, engagement and run reports, by composing the thread list yourself | [Local runtime](/docs/cloud/local-runtime#composing-the-thread-list-yourself) |
...
| The Cloud AI SDK, `useCloudChat` | nothing new: the package is deprecated and the runtime replaces it | [Migrate from Cloud AI SDK](/docs/cloud/ai-sdk) |
...
- If you use `@assistant-ui/cloud-ai-sdk`, plan the move: the package is deprecated; see [Migrate from Cloud AI SDK](/docs/cloud/ai-sdk).
