...
description: The sixteen engagement event kinds, all recorded by the SDK without message text, the message feedback and custom scores stored next to a conversation, and the evaluators the cloud runs for you.
---
...
|---|---|---|
| `message_sent`, `run_stopped`, `message_regenerated`, `thread_switched`, `error_shown`, `tool_approved`, `tool_rejected` | yes | yes |
