...
| `nuxt` | Nuxt template with Vercel AI SDK | `npx assistant-ui create -t nuxt` |
...
Options:
  -t, --template <template>      template to use (default, minimal, nuxt, cloud, cloud-clerk, langchain, mcp, eve)
