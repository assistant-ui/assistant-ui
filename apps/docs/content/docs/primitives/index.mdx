...
<Cards>
  ...
  <Card title="ChainOfThought" href="/docs/guides/chain-of-thought">
...
- [MessagePartPrimitive](/docs/reference/primitives/message-part)
...
- [ActionBarMorePrimitive](/docs/reference/primitives/action-bar-more)
- [AssistantIf (`AuiIf`)](/docs/reference/primitives/assistant-if)
