...
| `Suggestion` | `<button>` | Self-contained suggestion button *(legacy — prefer `Suggestions` iterator)* |
| `ViewportProvider` | — | Provides viewport context without a scrollable element (for custom scroll containers) |
| `ViewportSlack` | — | Adds min-height for scroll anchoring with `turnAnchor="top"` |
...
Related:
- [MessagePrimitive API Reference](/docs/reference/primitives/message)
- [ComposerPrimitive API Reference](/docs/reference/primitives/composer)
- [ThreadListPrimitive API Reference](/docs/reference/primitives/thread-list)
