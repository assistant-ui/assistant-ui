...
|------|---------|---------|
| `Root` | `<div>` | Container for the chain of thought group |
| `AccordionTrigger` | `<button>` | Toggles collapsed/expanded state |
| `Parts` | — | Renders reasoning and tool-call parts when expanded |
