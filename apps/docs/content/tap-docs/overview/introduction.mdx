...
`resource()` turns a Hook into a Resource — the pattern in the playground
above. To go further, [`useResource`](/tap/docs/tap/resources#hosting-a-resource)
hosts a single Resource, and
[`useResources`](/tap/docs/tap/composition#useresources) composes a keyed
collection.
