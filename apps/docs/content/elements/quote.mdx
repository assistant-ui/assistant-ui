...
import { QuoteBlock } from "@/components/assistant-ui/elements/quote.kit";
...
```tsx title="components/assistant-ui/elements/thread.kit.tsx"
import { SelectionToolbar } from "@/components/assistant-ui/elements/quote.kit";
...
```tsx title="components/assistant-ui/elements/thread.kit.tsx"
import { ComposerQuotePreview } from "@/components/assistant-ui/elements/quote.kit";
