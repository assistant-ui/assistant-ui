...
import { UserMessageAttachments } from "@/components/assistant-ui/elements/attachment.kit";
...
```tsx title="components/assistant-ui/elements/message-attachment.kit.tsx"
"use client";
