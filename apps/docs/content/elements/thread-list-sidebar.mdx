...
`ThreadListSidebar` does not expose header or footer content as props. Replace the literal links in your copy of `threadlist-sidebar.kit.tsx` with your own product name and support link.
