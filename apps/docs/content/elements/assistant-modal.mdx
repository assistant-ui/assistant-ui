...
<div className="aui-modal-content"> {/* opens above the trigger */}
  ...
  <div className="aui-modal-header">
    ...
    <button aria-label="Threads" aria-pressed className="aui-modal-threads" /> {/* history icon, pressed while the list shows */}
