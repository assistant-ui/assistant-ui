...
```tsx title="components/assistant-ui/elements/thread.kit.tsx"
"use client";
...
| File | Tooltip text |
|------|--------------|
| `thread.kit.tsx` | "Scroll to bottom", "Send message", "Voice input", "Stop dictation" |
| `thread.kit.tsx` | "Copy", "Refresh", "More", "Edit", "Previous", "Next" |
| `voice.kit.tsx` | "Mute" / "Unmute", "Disconnect" |
| `attachment.kit.tsx` | "Add Attachment", "Remove file" |
| `assistant-modal.kit.tsx` | "Open Assistant" / "Close Assistant" |
