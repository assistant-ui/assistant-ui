...
<PreviewCode file="components/design/specimens" name="ToastSpecimen" base={<ToastSpecimen />}>
...
<PreviewCode file="components/design/specimens" name="ToastTypesSpecimen" base={<ToastTypesSpecimen />}>
