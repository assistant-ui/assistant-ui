...
<KitInstall name="button" deps={["@base-ui/react"]} />
...
<PreviewCode file="components/design/specimens" name="ButtonSizesSpecimen">
  <ButtonSizesSpecimen />
</PreviewCode>
...
<PreviewCode file="components/design/specimens" name="ButtonIconSpecimen">
  <ButtonIconSpecimen />
</PreviewCode>
