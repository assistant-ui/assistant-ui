...
export const examples: DemoExample[] = [
  {
    ...
    chart: (
      <AppCard title="Review scores by category" meta="app store">
        <Violin
          title="Review scores by category"
          groups={[
            { label: "apps", widths: [1, 4, 9, 13, 10, 5, 2], median: 0.55 },
  ...
  },
  {
    ...
    chart: (
      <Paper
        kicker="Travel"
        title="The lottery of the cheap room"
        source="Source: 40k guest ratings"
      >
        <Violin
          ...
          groups={[
            {
              label: "luxury",
              widths: [0.5, 1, 2, 4, 8, 14, 10],
              median: 0.78,
            },
            {
              label: "midscale",
              widths: [1, 3, 7, 12, 12, 7, 2],
              median: 0.55,
            },
