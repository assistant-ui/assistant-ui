...
export function Report({
  ...
  return (
    <div className="w-full border border-[#e2e1dd] bg-[#f7f6f3] px-6 pt-5 pb-4 text-[#1c1c1a] [--dg-c1:#e07a52] [--dg-c2:#55b5a6] [--dg-c3:#4a7de0] [--dg-c4:#54555a] [--dg-surface:#f7f6f3]">
...
export function Terminal({
  ...
  return (
    <div className="w-full border border-[#1d2b26] bg-[#0b120f] px-5 pt-3.5 pb-4 font-[family-name:var(--font-mono)] text-[#c8d6cd] [--dg-c1:#34d399] [--dg-c2:#fbbf24] [--dg-c3:#38bdf8] [--dg-c4:#fb7185] [--dg-pos:#34d399] [--dg-surface:#0b120f]">
...
export function Paper({
  ...
  return (
    <div className="w-full border border-[#e6e0d4] bg-[#fbf8f1] px-6 pt-5 pb-4 text-[#191713] [--dg-c1:#274c77] [--dg-c2:#a63d40] [--dg-c3:#6b8f3d] [--dg-c4:#8a8577] [--dg-neg:#a63d40] [--dg-surface:#fbf8f1]">
      {kicker ? (
...
export function AppCard({
  ...
  return (
    <div className="w-full rounded-xl border border-[#e7e8ec] bg-white p-5 text-[#1f2330] shadow-[0_1px_2px_rgba(18,20,40,0.05),0_12px_32px_-16px_rgba(18,20,40,0.18)] [--dg-c1:#6366f1] [--dg-c2:#0ea5e9] [--dg-c3:#f59e0b] [--dg-c4:#10b981] [--dg-pos:#10b981] [--dg-surface:#ffffff]">
...
export function Slide({
  ...
  return (
    <div className="w-full bg-[#101014] px-7 pt-6 pb-5 text-[#ececf1] [--dg-c1:#7dd3fc] [--dg-c2:#f0abfc] [--dg-c3:#fde68a] [--dg-c4:#86efac] [--dg-surface:#101014]">
