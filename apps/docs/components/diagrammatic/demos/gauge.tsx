...
export const examples: DemoExample[] = [
  ...
  },
  {
    ...
    chart: (
      <AppCard title="Volume: /data" meta="appliance">
        <Gauge value={0.92} display="92%" label="disk used" />
      </AppCard>
    ),
  },
  {
    ...
    chart: (
      <Paper kicker="Money" title="Sixteen years in">
        <Gauge value={0.53} display="53%" label="mortgage paid" />
      </Paper>
    ),
  },
];
