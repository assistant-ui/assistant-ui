...
export const examples: DemoExample[] = [
  ...
  },
  {
    ...
    setup:
      "An SRE team's reliability page leads with one dial: how much of the quarter's error budget is already spent. One arc, one number, and a position that means something.",
