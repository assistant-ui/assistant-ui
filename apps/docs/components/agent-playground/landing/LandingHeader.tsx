    ...
    <header className="shrink-0 border-b bg-background">
      <div className="flex h-12 items-center justify-between px-4">
        <div className="flex items-center gap-2">
          {/* biome-ignore lint/performance/noImgElement: Product logos are small static assets and may be SVGs. */}
          <img
        ...
        <div className="flex items-center gap-1">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex h-7 items-center gap-1.5 rounded px-2.5 text-muted-foreground text-xs transition-colors hover:bg-accent hover:text-foreground"
          >
