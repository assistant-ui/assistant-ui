...
import {
  ...
  TooltipContent,
  TooltipTrigger,
} from "@/components/agent-playground/ui/tooltip";
import {
  Dialog,
  DialogTitle,
  DialogContent,
...
import {
  ...
  AvatarImage,
  AvatarFallback,
} from "@/components/agent-playground/ui/avatar";
...
const AttachmentPreview: FC<AttachmentPreviewProps> = ({ src }) => {
  ...
  return (
    // biome-ignore lint/performance/noImgElement: Attachment previews can use blob URLs that Next Image cannot optimize.
    <img
      src={src}
