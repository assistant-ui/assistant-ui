    ...
    >
      ...
      >
        ...
        <ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer sticky bottom-0 mx-auto mt-auto flex w-full max-w-(--thread-max-width) flex-col gap-4 overflow-visible rounded-t-(--composer-radius) bg-background pb-4 md:pb-6">
          ...
          <ApprovalCard approvals={approvals} onDecision={onApprovalDecision} />
          <WorkspaceEnvCard
            requests={workspaceEnvRequests}
            onSubmit={onWorkspaceEnvSubmit}
            onContinueWithout={onWorkspaceEnvContinueWithout}
          />
    ...
    <ComposerPrimitive.Root className="aui-composer-root relative flex w-full flex-col">
      ...
      >
        ...
        <ComposerPrimitive.Input
          placeholder="Message the assistant-ui agent..."
