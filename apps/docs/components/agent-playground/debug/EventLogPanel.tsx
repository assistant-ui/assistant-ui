...
export function EventLogPanel({
  ...
  return (
    <aside className="scrollbar-thin w-96 shrink-0 overflow-auto border-l bg-background p-3 text-muted-foreground text-xs">
          ...
          {debugLog.slice(-80).map((entry) => (
            <div key={entry.id} className="border-b pb-1 last:border-b-0">
              ...
              {entry.data !== undefined ? (
                <pre className="mt-1 whitespace-pre-wrap text-[11px] text-foreground/90">
