...
/**
 * Standalone MermaidDiagram that doesn't require AssistantRuntime context.
 * Use this for static demos and documentation.
 */
export const StandaloneMermaidDiagram: FC<{
  code: string;
  className?: string;
}> = ({ code, className }) => {
  const ref = useRef<HTMLPreElement>(null);
...
StandaloneMermaidDiagram.displayName = "StandaloneMermaidDiagram";
