...
import { ContextDisplay } from "@assistant-ui/ui/components/assistant-ui/elements/context-display";
      ...
      <div className="flex flex-col">
        ...
        {SUGGESTIONS.map((prompt, index) => (
          <ThreadPrimitive.Suggestion
            ...
            prompt={prompt}
            send
            className="group border-foreground/10 hero-rise flex w-full items-baseline gap-2.5 border-b py-2 text-left"
