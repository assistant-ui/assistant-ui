...
export function ElementsSidebar() {
  ...
  return (
    <aside className="hidden lg:block">
      <div className="bg-background sticky top-12 -mt-20 h-[calc(100dvh-3rem)] w-52 [scrollbar-width:none] overflow-y-auto overscroll-contain pt-20 pb-8 [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <Link
          href="/elements"
