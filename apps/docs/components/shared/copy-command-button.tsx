...
export function CopyCommandButton({
  ...
  const wrapperClassName =
    "group border-border/60 bg-muted/30 hover:border-border hover:bg-muted/50 inline-flex w-fit items-center gap-1.5 rounded-(--radius-control) border px-3 py-1.5 font-mono text-sm transition-all";
