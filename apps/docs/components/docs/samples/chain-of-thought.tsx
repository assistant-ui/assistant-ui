...
function ToggleChip({
  ...
  return (
    <button
      ...
      className={cn(
        "rounded-lg border px-2.5 py-1 font-medium font-mono text-xs transition-colors",
        pressed
...
function ChainOfThoughtPlayground() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 rounded-lg border bg-muted/30 p-2.5">
      ...
      {started ? (
        ...
        <div className="rounded-md border border-dashed p-4 text-muted-foreground text-sm">
          ...
          <span className="font-medium text-foreground">Start</span> to replay a
          ...
          <ChainOfThought.Trigger
            ...
            renderTriggerContent={() => (
              <span className="flex w-full min-w-0 items-center gap-2">
                <ChevronDownIcon className="size-4 shrink-0 text-muted-foreground transition-transform group-data-[state=closed]/trigger:-rotate-90" />
