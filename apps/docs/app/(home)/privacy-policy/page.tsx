...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "If you are visiting from the European Economic Area, the United Kingdom, or Switzerland, analytics that store information on your device run only after you accept them through our consent banner, and you can decline them there. You can change your choice at any time by clearing site data for assistant-ui.com in your browser, after which the banner will appear again. Wherever you are located, we honor the Global Privacy Control (GPC) signal: if your browser broadcasts GPC, we disable analytics for your visit.",
    ],
  },
  {
    ...
    body: [
      ...
      "When you use the AI assistant on our website, your messages and the responses generated for you are processed by our AI Service Providers and are logged, together with usage metadata, so that we can monitor quality, safety, abuse, and cost. Please do not include sensitive personal information in your messages to the assistant.",
  ...
  },
  {
    ...
    body: [
      ...
      "We do recognize and honor the Global Privacy Control (GPC) signal. If your browser or browser extension broadcasts GPC, we treat it as an opt-out and disable analytics for your visit.",
    ],
  },
  {
