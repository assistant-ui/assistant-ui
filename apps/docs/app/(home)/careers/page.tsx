  ...
  return (
    <PageFrame pad="sub">
      <header className="max-w-2xl">
        <h1 className={typePage}>Build the library.</h1>
      ...
      <div className="border-foreground/10 mt-4 border-t">
        <div className="divide-foreground/10 border-foreground/10 grid divide-y border-b md:grid-cols-3 md:divide-x md:divide-y-0">
