    ...
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-24 px-6 pt-20 pb-24 sm:px-8 lg:px-0">
      <section className="space-y-6 text-center">
        ...
        <p className="mx-auto max-w-2xl text-base text-muted-foreground sm:text-lg">
          ...
          next generation of AI-native products. Join us if you care about beautiful
          interfaces, fast iteration, and developer velocity.
        </p>
      </section>
      ...
      <section className="grid gap-10">
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            Don't see the perfect fit? We'd still love to hear from you - drop us a note at
