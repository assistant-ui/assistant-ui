...
- **@assistant-ui/react-core**: Core types and client abstractions (new package)
...
- The tap package must be built before packages that depend on it (react, react-core)