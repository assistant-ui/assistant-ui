...
class StateProxy:
    ...
    def __setitem__(self, key: Union[str, int], value: Any) -> None:
        ...
        self._manager.add_operations([
            ObjectStreamSetOperation(path=self._path + [str(key)], value=value)
        ])
    ...
    def __iadd__(self, other: Any) -> "StateProxy":
        ...
        if isinstance(current_value, str):
            ...
            self._manager.add_operations([
                ObjectStreamAppendTextOperation(path=self._path, value=other)
            ])
            return self
        ...
        raise TypeError(f"unsupported operand type(s) for +=: '{type(current_value).__name__}' and '{type(other).__name__}'")
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        raise AttributeError(f"'{type(value).__name__}' object has no attribute '{name}'")
    ...
    def append(self, item: Any) -> None:
        ...
        self._manager.add_operations([
            ObjectStreamSetOperation(path=self._path + [str(len(value))], value=item)
        ])
    ...
    def clear(self) -> None:
        ...
        if isinstance(value, (list, dict)):
            ...
            self._manager.add_operations([
                ObjectStreamSetOperation(path=self._path, value=empty_value)
            ])
        else:
    ...
    def setdefault(self, key, default=None):
        ...
        value = self._manager.get_value_at_path(self._path)
        if not isinstance(value, dict):
            raise TypeError(f"'setdefault' not supported for type {type(value).__name__}")
    ...
    def pop(self, *args):
        ...
        raise NotImplementedError("Would require sending the entire collection over the network")
        
    def remove(self, item: Any) -> None:
        """Not supported - would require sending entire list."""
        raise NotImplementedError("Would require sending the entire list over the network")
    ...
    def popitem(self):
        """Not supported - would require sending entire dictionary."""
        raise NotImplementedError("Would require sending the entire dictionary over the network")
