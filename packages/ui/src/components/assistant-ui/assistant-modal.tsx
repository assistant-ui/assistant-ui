...
>(({ "data-state": state, ...rest }, ref) => {
  ...
  return (
    <TooltipIconButton
      ...
      side="left"
      {...rest}
      className="aui-modal-button size-full rounded-full shadow-lg transition-transform duration-150 ease-out hover:scale-105 active:scale-95 motion-reduce:transition-none"
      ref={ref}
    >
      <BotIcon
        data-state={state}
