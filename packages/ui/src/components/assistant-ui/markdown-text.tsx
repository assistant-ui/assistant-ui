...
const defaultComponents = memoizeMarkdownComponents({
  ...
  table: ({ className, ...props }) => (
    <table
      className={cn(
        "aui-md-table my-3 w-full border-separate border-spacing-0 overflow-y-auto [scrollbar-color:var(--color-border)_transparent] [scrollbar-width:thin]",
        className,
      )}
      {...props}
    />
  ...
  pre: ({ className, ...props }) => (
    <pre
      className={cn(
        "aui-md-pre border-border/50 bg-muted/30 overflow-x-auto rounded-t-none rounded-b-xl border border-t-0 p-3.5 text-[13px] leading-relaxed [scrollbar-color:var(--color-border)_transparent] [scrollbar-width:thin]",
        className,
      )}
      {...props}
    />
