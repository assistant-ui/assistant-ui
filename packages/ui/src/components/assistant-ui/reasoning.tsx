...
function ReasoningText({
  ...
  return (
    <div
      ...
      className={cn(
        "aui-reasoning-text relative z-0 max-h-64 overflow-y-auto ps-6 pt-2 pb-2 leading-relaxed text-pretty [scrollbar-color:var(--color-border)_transparent] [scrollbar-width:thin]",
