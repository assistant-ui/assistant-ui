...
export function CommandTabs({
  ...
  return (
    <figure
      ...
      {...props}
    >
      <div className="border-foreground/10 flex h-10 shrink-0 items-center justify-between gap-2 border-b py-0 ps-1.5 pe-2">
        <div
          role="tablist"
        ...
        >
          {labels.map((label) => (
            <button
              ...
              className={cn(
                "flex h-6 shrink-0 items-center rounded-(--radius-sm) px-2 font-mono text-[11px] font-medium tracking-wide transition-colors",
                label === active
