...
export class MessageRepository {
   ...
   * client-id placeholder before the head moves to it) is kept until a head
   * move leaves the branch it is on. Keeps a client→server id swap from
   * leaving a phantom sibling.
   */
